...
# For additional configuration options, see: https://aaronsky.github.io/applereleaser/usage/customization
#
...
func initProject(f *os.File) error {
	...
	log.Info("For additional configuration options, see: https://aaronsky.github.io/applereleaser/usage/customization")
